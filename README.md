...
yum install cmake devscripts dpkg alien fakeroot -y
``` 
...
alien --scripts --to-rpm ./out/Default/chromium-browser-unstable_127.0.6526.0-1_amd64.deb
...
# instead to remove the dinosaur it has to be disabled with the bitmap generator 
